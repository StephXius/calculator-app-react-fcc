...
class App extends React.Component {constructor(...args) {super(...args);_defineProperty(this, "state",
        ...
        default:{
            ...
            if (ops.includes(innerText)) {
              ...
              innerText !== '.') {
                ...
                calc.split('').reverse().
                findIndex((char) =>
                char !== ' ' && nums.includes(+char));
                e = calc.slice(0,
                calc.length - lastNumberIdx) + `${innerText}`;
              } else {
                e = `${calc} ${innerText}`;
              }
            } else {
              e = calc === '0' ?
              innerText : calc + innerText;
            }
            this.setState({
              calc: e });
  ...
  render() {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("button", { className: "big-h light-grey ac", onClick: this.handleClick,
        id: "clear" }, "AC"),
